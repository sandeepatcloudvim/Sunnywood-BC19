        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(ShipToAddr; "Sales Header"."Ship-to Address" + ' ' + "Sales Header"."Ship-to Address 2")
                    {

                    }
                    column(ShipToInfo; "Sales Header"."Ship-to City" + ' ' + "Sales Header"."Ship-to County" + ' ' + "Sales Header"."Ship-to Post Code")
                    {
                    ...
                    dataitem(SalesLine; "Integer")
                    {
                        ...
                        column(TempSales_Shipped; TempSalesLine."Qty. to Ship")
                        {
