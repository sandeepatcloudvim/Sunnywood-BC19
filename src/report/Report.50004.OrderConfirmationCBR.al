report 50004 "Sales Order Confirmation CBR"
{
    DefaultLayout = RDLC;
    ...
    var
        ...
        SalesOrderCaptionLbl: TextConst ENU = 'Order Confirmation', ESM = 'PEDIDO VENTA', FRC = 'DOCUMENT DE VENTE', ENC = 'Order Confirmation';
        SalesOrderNumberCaptionLbl: TextConst ENU = 'Order', ESM = 'Número pedido venta:', FRC = 'Numéro du document de vente :', ENC = 'Order';
        SalesOrderDateCaptionLbl: TextConst ENU = 'Date', ESM = 'Fecha pedido venta:', FRC = 'Date du document de vente :', ENC = 'Date';
