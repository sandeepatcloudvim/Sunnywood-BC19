report 50006 "New Pick Instruction"
{
    DefaultLayout = RDLC;
    RDLCLayout = './CBRPickInstruction.rdl';
    Caption = 'CBR Pick Instruction';
        ...
        dataitem(CopyLoop; "Integer")
        {
            ...
            dataitem("Sales Header"; "Sales Header")
            {
                ...
                begin
                    ...
                    ShipTo[3] := "Ship-to City" + ' ' + "Ship-to County" + ' ' + "Ship-to Post Code";
    ...
    labels
    {
        ...
        ExternalDocCaption = 'Ext. Document No.';
    }
